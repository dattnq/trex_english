...
const snapshot=z.array(z.object({reading:readingSchema.nullish(),number:z.number().nullish(),prompt:z.string(),options:z.array(z.string()),answer:z.number().int(),explanation:z.string().optional()}));
