...
- `src/components/session-player.tsx`: đồng hồ, lựa chọn, chuyển câu test, phản hồi quiz và tổng điểm. Poll không khóa nút trả lời. Test đồng bộ mỗi 5 giây và lúc hết hạn; quiz đồng bộ khi đến hạn hoặc quay lại tab. Lựa chọn gửi ngay, lỗi mạng được báo rõ.
...
Quiz chờ trình duyệt nhận câu mới rồi gửi xác nhận bắt đầu lượt trả lời. Đồng hồ hiển thị bắt đầu từ 10 giây và không bị đặt lại bởi phản hồi mạng trong cùng câu. Trong lúc trả lời, quiz chỉ đồng bộ khi chọn đáp án, đến hạn hoặc quay lại tab; không gửi poll định kỳ tranh chỗ với lựa chọn. Câu đang trả lời vẫn hết giờ khi rời tab; câu chưa mở chờ tối đa 5 phút rồi kết thúc phiên. Tải lại trang không cấp lại thời gian cho câu đã bắt đầu.
